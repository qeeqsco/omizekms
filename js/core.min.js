        ...
        easyResponsiveTabs: function(l) {
            ...
            f(this).on("bind", "tabactivate", function(t, e) {
                ...
                o.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify), o.css({
                    display: "block",
                    width: u
                }), "vertical" == l.type && t.css("margin-top", "3px"), o.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color), o.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify), "vertical" == c && o.addClass("resp-vtabs").addClass(l.tabidentify), 1 == h && o.css({
                    width: "100%",
                    margin: "0px"
