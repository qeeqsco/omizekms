...
! function(t) {
    ...
    t("#preloader").fadeOut("normall", function() {
        ...
        e <= 50 ? (t("header").removeClass("scrollHeader").addClass("fixedHeader"), a.attr("src", "img/logos/Omize.png")) : (t("header").removeClass("fixedHeader").addClass("scrollHeader"), a.attr("src", "img/logos/Omize.png")), o.attr("src", "img/logos/Omize.png")
    }), i.on("scroll", function() {
        500 < t(this).scrollTop() ? t(".scroll-to-top").fadeIn(400) : t(".scroll-to-top").fadeOut(400)
    }), t(".scroll-to-top").on("click", function(e) {
        const newLocal = "html, body";
        e.preventDefault(), t(newLocal).animate({
            scrollTop: 0
        }, 600)
    }), new WOW({
        boxClass: "wow",
    ...
    })), e = t(".full-screen"), a = i.height(), e.css("min-height", a), e = t("header").height(), a = t(".screen-height"), e = i.height() - e, a.css("height", e), t(document).ready(function() {
        t(".testimonial-carousel").owlCarousel({
        ...
        }), t(".pricing-carousel").owlCarousel({
            loop: !0,
            responsiveClass: !0,
            autoplay: !1,
            smartSpeed: 1500,
        ...
        }), t(".portfolio-single").owlCarousel({
            loop: !0,
            responsiveClass: !0,
            autoplay: !0,
            smartSpeed: 800,
        ...
        }), t(".slider-fade .owl-carousel").owlCarousel({
            items: 1,
            loop: !0,
            dots: !1,
            margin: 0,
            ...
            e = e.item.index - 2;
            t("h3").removeClass("animated fadeInUp"), t("h1").removeClass("animated fadeInUp"), t("p").removeClass("animated fadeInUp"), t(".butn").removeClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("h3").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("h1").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find("p").addClass("animated fadeInUp"), t(".owl-item").not(".cloned").eq(e).find(".butn").addClass("animated fadeInUp")
